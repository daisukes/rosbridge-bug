...
def topic_callback(msg):
    ...
    if msg['data'] == "Ping":
        ...
        topic_pub.publish(pong)


# it works if we use separated Topic instance for publish/subscription
topic_pub = roslibpy.Topic(client, '/topic', 'std_msgs/String')
topic_sub = roslibpy.Topic(client, '/topic', 'std_msgs/String')
topic_sub.subscribe(topic_callback)
